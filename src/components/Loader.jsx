...
const Loader = ({ onLoadingComplete }) => {
  ...
  useEffect(() => {
    ...
    const interval = 20; // update every 30ms
...
const StyledWrapper = styled.div`
  ...
  .percentage-text {
    ...
    margin-bottom: 10px;
    color: white;
    text-shadow: 0 0 10px rgba(248, 168, 168, 0.5);
  }
  ...
  .progress-fill {
    height: 100%;
    background: linear-gradient(90deg, #f51313, #ff6b6b);
    border-radius: 2px;
    transition: width 0.1s ease;
    box-shadow: 0 0 10px rgba(245, 19, 19, 0.5);
  }
